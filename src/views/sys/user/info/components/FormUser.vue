    ...
    <el-container>
      <el-aside width="30%">
        <div style="text-align:center;">
          ...
          >
            <el-button size="mini" type="info" style="color:#000;" plain>
              修改头像
            </el-button>
          </el-upload>
        </div>
      ...
      <el-main>
        ...
        <el-form-item>
          <span>
            上次登录： 时间{{ userinfo.lastLoginDate }} IP:{{
        ...
        mobile: [
          {
            ...
            message: '请正确填写您的手机号码，只能是13,14,15,16,17,18,19号段',
            trigger: ['blur', 'change']
          }
        ],
        phone: {
          pattern: /^(\(\d{3,4}\)|\d{3,4}-|\s)?\d{7,14}$/,
          message: '请正确填写您的电话号码，固话为区号(3-4位)号码(7-9位)',
          trigger: ['blur', 'change']
        },
        sign: { max: 100 }
      }
